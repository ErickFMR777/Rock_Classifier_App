...
export const ui = {
  ...
  classifier: {
    ...
    footerLeft: {
      es: 'RockClassifier.ai — Impulsado por ResNet50 + PyTorch',
      en: 'RockClassifier.ai — Powered by ResNet50 + PyTorch',
    } satisfies Localized<string>,
    footerRight: {
      es: 'React + FastAPI + Aprendizaje profundo',
      en: 'React + FastAPI + Deep Learning',
    } satisfies Localized<string>,
  },
  ...
  loading: {
    ...
    subtitle: {
      es: 'Usando IA de aprendizaje profundo (ResNet50)',
      en: 'Using deep learning AI (ResNet50)',
    } satisfies Localized<string>,
  },
  ...
  about: {
    ...
    steps: {
      es: [
        ...
        { title: 'Procesar', description: 'La imagen se redimensiona a 224×224 y se normaliza con las estadísticas de ImageNet.' },
      ...
      en: [
        ...
        { title: 'Process', description: 'The image is resized to 224×224 and normalized using ImageNet statistics.' },
    ...
    specs: {
      es: [
        ...
        { label: 'Tamaño de entrada', value: '224 × 224 px', detail: 'Imágenes RGB redimensionadas automáticamente' },
        { label: 'Clases de salida', value: '25 tipos de roca', detail: 'Ígneas, sedimentarias y metamórficas' },
        { label: 'Inferencia', value: '< 2 segundos', detail: 'En CPU (no requiere GPU)' },
      ],
      en: [
    ...
    training: {
      es: [
        { label: 'Conjunto de datos', value: '816 imágenes', detail: '~30-80 por clase, obtenidas de la web' },
        { label: 'Épocas', value: '30', detail: 'Cosine Annealing con reinicios cálidos' },
        { label: 'Tamaño de lote', value: '8', detail: 'Con sobremuestreo 3× por época' },
        { label: 'Optimizador', value: 'AdamW', detail: 'Tasas diferenciadas: backbone 1e-4, FC 1e-3' },
        { label: 'Regularización', value: 'Multiestrategia', detail: 'Dropout 0,4, label smoothing 0,1, mixup' },
        { label: 'Tiempo de entrenamiento', value: '~125 min', detail: 'Solo CPU (GitHub Codespaces)' },
      ],
      en: [
