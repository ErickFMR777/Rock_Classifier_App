...
// Fallback per-class metrics, shown only when GET /api/model/metrics is
// unreachable. Mirrors api/_lib/metrics.json for the deployed model
// (298 validation images, 40.6% top-1) so the offline view does not report
// numbers from a different training run than the online one.
const classMetrics: { name: string; precision: number; recall: number; f1: number; support: number; category: 'igneous' | 'sedimentary' | 'metamorphic' }[] = [
  { name: 'Andesite',      precision: 0.25, recall: 0.40, f1: 0.31, support: 5,  category: 'igneous' },
  { name: 'Basalt',        precision: 0.50, recall: 0.43, f1: 0.46, support: 14, category: 'igneous' },
  { name: 'Breccia',       precision: 0.37, recall: 0.50, f1: 0.42, support: 14, category: 'sedimentary' },
  { name: 'Chalk',         precision: 0.80, recall: 0.86, f1: 0.83, support: 14, category: 'sedimentary' },
  { name: 'Conglomerate',  precision: 0.42, recall: 0.36, f1: 0.38, support: 14, category: 'sedimentary' },
  { name: 'Diorite',       precision: 0.71, recall: 0.86, f1: 0.77, support: 14, category: 'igneous' },
  { name: 'Dolomite',      precision: 0.17, recall: 0.14, f1: 0.15, support: 14, category: 'sedimentary' },
  { name: 'Dunite',        precision: 1.00, recall: 0.43, f1: 0.60, support: 14, category: 'igneous' },
  { name: 'Flint',         precision: 0.33, recall: 0.33, f1: 0.33, support: 9,  category: 'sedimentary' },
  { name: 'Gneiss',        precision: 0.40, recall: 0.25, f1: 0.31, support: 8,  category: 'metamorphic' },
  { name: 'Granite',       precision: 0.25, recall: 0.21, f1: 0.23, support: 14, category: 'igneous' },
  { name: 'Limestone',     precision: 0.36, recall: 0.29, f1: 0.32, support: 14, category: 'sedimentary' },
  { name: 'Marble',        precision: 0.27, recall: 0.50, f1: 0.35, support: 8,  category: 'metamorphic' },
  { name: 'Obsidian',      precision: 0.67, recall: 0.50, f1: 0.57, support: 8,  category: 'igneous' },
  { name: 'Pegmatite',     precision: 0.23, recall: 0.36, f1: 0.28, support: 14, category: 'igneous' },
  { name: 'Porphyry',      precision: 0.31, recall: 0.29, f1: 0.30, support: 14, category: 'igneous' },
  { name: 'Pumice',        precision: 0.00, recall: 0.00, f1: 0.00, support: 6,  category: 'igneous' },
  { name: 'Quartzite',     precision: 0.50, recall: 0.57, f1: 0.53, support: 7,  category: 'metamorphic' },
  { name: 'Rhyolite',      precision: 0.67, recall: 0.29, f1: 0.40, support: 14, category: 'igneous' },
  { name: 'Sandstone',     precision: 0.33, recall: 0.21, f1: 0.26, support: 14, category: 'sedimentary' },
  { name: 'Schist',        precision: 0.42, recall: 0.36, f1: 0.38, support: 14, category: 'metamorphic' },
  { name: 'Shale',         precision: 0.23, recall: 0.36, f1: 0.28, support: 14, category: 'sedimentary' },
  { name: 'Slate',         precision: 0.56, recall: 0.69, f1: 0.62, support: 13, category: 'metamorphic' },
  { name: 'Syenite',       precision: 0.43, recall: 0.30, f1: 0.35, support: 10, category: 'igneous' },
  { name: 'Tuff',          precision: 0.39, recall: 0.50, f1: 0.44, support: 14, category: 'igneous' },
];
